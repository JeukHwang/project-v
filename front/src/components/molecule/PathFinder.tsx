...
export function PathFinder() {
  ...
  //   const [path, setPath] = useState<{ [key in string]: RoadPointNode }>();
  ...
  useEffect(() => {
    ...
    console.log(findShortestPathWith1UniqueRoad(startPoint, endPoint));
    // const closestNodeFromStart = findClosestNode(startPoint, "ALL", true);
    // const closestNodeFromEnd = findClosestNode(endPoint, "ALL", false);
