...
export const DATE: {
  ...
  남해고속도로제3지선: {
    ...
    geo: [
      ...
      ["신항 나들목", [35.0942042, 128.7652902]], // 진해본선요금소
    ],
    time: ["2017.01.13"],
  },
  무안광주고속도로: {
  ...
  울산고속도로: {
    geo: [
      ...
      ["울산 갈림목", [35.5529013, 129.25879634296308]],
    ],
    time: ["1969.12.29"],
  },
  새만금포항고속도로: {
    geo: [
      ...
      // not render??
      ["팔공산 나들목", [35.9073353, 128.6409554]],
...
export const ICJC_CANDIDATE = Object.values(DATE)
  .map((v) => v.geo)
  .filter((v) => v)
  .flat()
  .map((v) => ({ name: v[0], point: v[1] }));

ICJC_CANDIDATE.push(
  {
    name: "춘천 갈림목",
    point: [37.7555892, 127.7918207],
  },
  {
    name: "춘천 갈림목",
    point: [37.7555892, 127.7918207],
  ...
  {
    name: "만종 갈림목",
    point: [37.3663769, 127.9060439],
  },
  {
    name: "제천 갈림목",
    point: [37.0769344, 128.1811003],
  },
  {
    name: "소흘 갈림목",
    point: [37.8121492, 127.1384126],
  },
  {
    name: "일산 갈림목", // 실제로는 나들목임
    point: [37.6387503, 126.8047234],
  },
  {
    name: "서운 갈림목",
    point: [37.5242327, 126.7616433],
  },
  {
    name: "평촌 나들목",
    point: [37.3778736, 126.9543949],
  },
  {
    name: "강일 나들목", // 실제로는 아닌가...?
    point: [37.5745318, 127.163888],
  },
  {
    name: "동탄 갈림목",
    point: [37.1779363, 127.0915986],
  },
  {
    name: "공주 갈림목",
    point: [36.4828701, 127.0904874],
  },
  {
    name: "고창 갈림목",
    point: [35.4140863, 126.6504184],
  },
  {
    name: "함평 갈림목",
    point: [35.0295142, 126.4864107],
  },
  {
    name: "서순천 갈림목", // 사실 나들목
    point: [35.0032217, 127.4825792],
  },
  {
    name: "남원 갈림목",
    point: [35.4033054, 127.2997181],
  },
  {
    name: "함양 갈림목",
    point: [35.535396, 127.7711876],
  },
  {
    name: "장수 갈림목",
    point: [35.7244626, 127.6108663],
  },
  {
    name: "의암 갈림목", // 새만금, 완주장수선
    point: [35.80707, 127.25391],
  },
  {
    name: "김천 갈림목",
    point: [36.1613136, 128.2595496],
  },
  {
    name: "함경주 갈림목",
    point: [35.5132875, 129.1194665]
  }, 
  {
    name: "칠곡 갈림목",
    point: [35.9068801, 128.4877524],
  },
  {
    name: "영천 갈림목",
    point: [35.9234579, 129.0060849],
  },
);
